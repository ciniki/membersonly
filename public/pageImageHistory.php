...
function ciniki_membersonly_pageImageHistory($ciniki) {
    ...
    $rc = ciniki_membersonly_checkAccess($ciniki, $args['tnid'], 'ciniki.membersonly.pageImageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.membersonly', 'ciniki_membersonly_history', 
        $args['tnid'], 'ciniki_membersonly_page_images', $args['page_image_id'], $args['field']);
}
?>
