...
function ciniki_membersonly_pageAdd(&$ciniki) {
    ...
    $rc = ciniki_membersonly_checkAccess($ciniki, $args['tnid'], 'ciniki.membersonly.pageAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    } 
    ...
    return ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.membersonly.page', $args, 0x07);
}
?>
