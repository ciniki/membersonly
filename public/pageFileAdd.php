...
function ciniki_membersonly_pageFileAdd(&$ciniki) {
    ...
    $rc = ciniki_membersonly_checkAccess($ciniki, $args['business_id'], 'ciniki.membersonly.pageFileAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.membersonly.page_file', $args, 0x07);
}
?>
