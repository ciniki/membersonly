...
//	</users>
//
function ciniki_membersonly_pageHistory($ciniki) {
	//
	...
	$rc = ciniki_membersonly_checkAccess($ciniki, $args['business_id'], 'ciniki.membersonly.pageHistory');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.membersonly', 'ciniki_membersonly_history', 
		$args['business_id'], 'ciniki_membersonly_pages', $args['page_id'], $args['field']);
}
?>
