...
function ciniki_membersonly_pageFileGet($ciniki) {
    ...
    $rc = ciniki_membersonly_checkAccess($ciniki, $args['business_id'], 'ciniki.membersonly.pageFileGet'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
...
//  $date_format = ciniki_users_dateFormat($ciniki);
    ...
    $strsql = "SELECT ciniki_membersonly_page_files.id, "
        ...
        . "WHERE ciniki_membersonly_page_files.business_id = '" . ciniki_core_dbQuote($ciniki, $args['business_id']) . "' "
